 ...
 */
public class SetProperties extends UserAction<IMendixObject>
{
	/** @deprecated use com.mendix.utils.ListUtils.map(modelObjects, com.mendix.systemwideinterfaces.core.IEntityProxy::getMendixObject) instead. */
	@java.lang.Deprecated(forRemoval = true)
	private final java.util.List<IMendixObject> __modelObjects;
	private final java.util.List<tcconnector.proxies.ModelObject> modelObjects;
	private final java.lang.String businessObjectMapping;
	private final java.lang.String ConfigurationName;

	public SetProperties(
		IContext context,
		java.util.List<IMendixObject> _modelObjects,
		java.lang.String _businessObjectMapping,
		java.lang.String _configurationName
	)
	{
		super(context);
		this.__modelObjects = _modelObjects;
		this.modelObjects = java.util.Optional.ofNullable(_modelObjects)
			.orElse(java.util.Collections.emptyList())
			.stream()
			.map(modelObjectsElement -> tcconnector.proxies.ModelObject.initialize(getContext(), modelObjectsElement))
