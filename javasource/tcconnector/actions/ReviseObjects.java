 ...
 */
public class ReviseObjects extends UserAction<IMendixObject>
{
	/** @deprecated use objectToRevise.getMendixObject() instead. */
	@java.lang.Deprecated(forRemoval = true)
	private final IMendixObject __objectToRevise;
	private final tcconnector.proxies.WorkspaceObject objectToRevise;
	/** @deprecated use reviseInput.getMendixObject() instead. */
	@java.lang.Deprecated(forRemoval = true)
	private final IMendixObject __reviseInput;
	private final tcconnector.proxies.ReviseInputs reviseInput;
	private final java.lang.String businessObjectMapping;
	private final java.lang.String ConfigurationName;

	public ReviseObjects(
		IContext context,
		IMendixObject _objectToRevise,
		IMendixObject _reviseInput,
		java.lang.String _businessObjectMapping,
		java.lang.String _configurationName
	)
	{
		super(context);
		this.__objectToRevise = _objectToRevise;
		this.objectToRevise = _objectToRevise == null ? null : tcconnector.proxies.WorkspaceObject.initialize(getContext(), _objectToRevise);
		this.__reviseInput = _reviseInput;
		this.reviseInput = _reviseInput == null ? null : tcconnector.proxies.ReviseInputs.initialize(getContext(), _reviseInput);
