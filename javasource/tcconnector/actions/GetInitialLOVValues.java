 ...
 */
public class GetInitialLOVValues extends UserAction<IMendixObject>
{
	/** @deprecated use inputEntity.getMendixObject() instead. */
	@java.lang.Deprecated(forRemoval = true)
	private final IMendixObject __inputEntity;
	private final tcconnector.proxies.GetInitialLOVValuesInputEntity inputEntity;
	private final java.lang.String configurationName;

	public GetInitialLOVValues(
		IContext context,
	...
	)
	{
		...
		this.inputEntity = _inputEntity == null ? null : tcconnector.proxies.GetInitialLOVValuesInputEntity.initialize(getContext(), _inputEntity);
