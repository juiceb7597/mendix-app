 ...
 * 
 */
public class Login extends UserAction<java.lang.Boolean>
{
	/** @deprecated use UserCredentials.getMendixObject() instead. */
	@java.lang.Deprecated(forRemoval = true)
	private final IMendixObject __UserCredentials;
	private final tcconnector.proxies.Credentials UserCredentials;
	private final java.lang.String ConfigurationName;

	public Login(
		IContext context,
		IMendixObject _userCredentials,
		java.lang.String _configurationName
	)
	{
		super(context);
		this.__UserCredentials = _userCredentials;
		this.UserCredentials = _userCredentials == null ? null : tcconnector.proxies.Credentials.initialize(getContext(), _userCredentials);
