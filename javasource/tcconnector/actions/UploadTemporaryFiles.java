 ...
 */
public class UploadTemporaryFiles extends UserAction<java.util.List<IMendixObject>>
{
	private final java.lang.String ConfigurationName;
	/** @deprecated use com.mendix.utils.ListUtils.map(Files, com.mendix.systemwideinterfaces.core.IEntityProxy::getMendixObject) instead. */
	@java.lang.Deprecated(forRemoval = true)
	private final java.util.List<IMendixObject> __Files;
	private final java.util.List<tcconnector.proxies.FileDocument> Files;

	public UploadTemporaryFiles(
		IContext context,
		java.lang.String _configurationName,
		java.util.List<IMendixObject> _files
	)
	{
		super(context);
		this.ConfigurationName = _configurationName;
		this.__Files = _files;
		this.Files = java.util.Optional.ofNullable(_files)
			.orElse(java.util.Collections.emptyList())
			.stream()
			.map(filesElement -> tcconnector.proxies.FileDocument.initialize(getContext(), filesElement))
