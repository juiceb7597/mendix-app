 ...
 */
public class GetAllTasks extends UserAction<IMendixObject>
{
	/** @deprecated use InputData.getMendixObject() instead. */
	@java.lang.Deprecated(forRemoval = true)
	private final IMendixObject __InputData;
	private final tcconnector.proxies.GetAllTasksInput InputData;
	...
	)
	{
		...
		this.InputData = _inputData == null ? null : tcconnector.proxies.GetAllTasksInput.initialize(getContext(), _inputData);
