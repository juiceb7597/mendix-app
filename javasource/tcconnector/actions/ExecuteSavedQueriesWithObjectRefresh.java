 ...
 */
public class ExecuteSavedQueriesWithObjectRefresh extends UserAction<IMendixObject>
{
	private final java.lang.String QueryName;
	private final IMendixObject InputData;
	private final java.lang.String BusinessObjectMappings;
	private final java.lang.String ConfigurationName;

	public ExecuteSavedQueriesWithObjectRefresh(
		IContext context,
		java.lang.String _queryName,
	...
	public IMendixObject executeAction() throws Exception
	{
		...
		JSONArray modelObjUidArray = arrayOfResults.getJSONArray(KEY_OBJECT_UIDS);
		JSONArray modelObjArray = new JSONArray();
		for(int i = 0; i < modelObjUidArray.length(); ++i) {
			JSONObject modelObj = new JSONObject();
			modelObj.put(KEY_UID, modelObjUidArray.get(i));
			modelObjArray.put(modelObj);
		}
		JSONObject refreshObjInputJSON = new JSONObject();
		refreshObjInputJSON.put(KEY_OBJECTS, modelObjArray);
		// Call refreshObjects SOA
		JSONObject refreshObjectsResult = TcConnection.callTeamcenterService(context, Constants.OPERATION_REFRESH_OBJECTS,
				refreshObjInputJSON, policy, ConfigurationName);
	...
	{
		return "ExecuteSavedQueriesWithObjectRefresh";
	}
