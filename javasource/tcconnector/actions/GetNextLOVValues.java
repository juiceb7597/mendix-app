 ...
 */
public class GetNextLOVValues extends UserAction<IMendixObject>
{
	/** @deprecated use lovDataEntity.getMendixObject() instead. */
	@java.lang.Deprecated(forRemoval = true)
	private final IMendixObject __lovDataEntity;
	private final tcconnector.proxies.LOVDataEntity lovDataEntity;
	private final java.lang.String configurationName;

	public GetNextLOVValues(
		IContext context,
		IMendixObject _lovDataEntity,
		java.lang.String _configurationName
	)
	{
		super(context);
		this.__lovDataEntity = _lovDataEntity;
		this.lovDataEntity = _lovDataEntity == null ? null : tcconnector.proxies.LOVDataEntity.initialize(getContext(), _lovDataEntity);
