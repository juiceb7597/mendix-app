...
public class CreateBOMWindows extends UserAction<IMendixObject>
{
	...
	)
	{
		...
		this.InputData = _inputData == null ? null : tcconnector.proxies.CreateBomWindowInput.initialize(getContext(), _inputData);
