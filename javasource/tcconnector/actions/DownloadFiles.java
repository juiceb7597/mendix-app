 ...
 * 
 */
public class DownloadFiles extends UserAction<java.lang.Boolean>
{
	...
	private ArrayList<FileDocument> downloadFilesFromFMS(JSONObject getFileReadTicketsResponse,
		...
		ArrayList<FileDocument> documents = new java.util.ArrayList<>();
	...
	private FileDocument downloadFiles(List<String> fileTciketAndNameList, String[] fmsURLs,
		...
		document.setdatasetUID(datasetUid);
		document.setimanFileID(imanFileID);
