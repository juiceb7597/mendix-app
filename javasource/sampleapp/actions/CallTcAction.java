...
public class CallTcAction extends UserAction<java.lang.String>
{
	...
	public java.lang.String executeAction() throws Exception
	{
        ...
        try {
            ...
            JSONObject inputJson = new JSONObject(this.InputString);

//            ensureUserLoggedIn(getContext(), this.ConfigurationName);

            // Call Teamcenter Service
            JSONObject response = TcConnection.callTeamcenterService(getContext(), this.ServiceName, inputJson, null, this.ConfigurationName);
