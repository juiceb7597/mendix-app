...
/**
 * Copies attributes from ModelObject to BaseCreateInput, where attributes are defined on both objects with the same type. Attributes that are not defined on ModelObject and attributes that are defined on both, but with a different attribute type, will be skipped. The JA will instantiate an object of the entity type defined.
 */
public class JA_CopyModelObjectToNewCreateInput extends UserAction<IMendixObject>
{
	...
	public JA_CopyModelObjectToNewCreateInput(
		IContext context,
	...
	{
		return "JA_CopyModelObjectToNewCreateInput";
	}
