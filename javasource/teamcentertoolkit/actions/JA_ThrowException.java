...
/**
 * This action always throws an exception (of type CoreException), which is, in combination with custom error handling, quite useful to end a microflow prematurely or to bail out to the calling action/ microflow. 
 * 
 ...
 */
public class JA_ThrowException extends UserAction<java.lang.Boolean>
{
	private final java.lang.String message;

	public JA_ThrowException(
		IContext context,
